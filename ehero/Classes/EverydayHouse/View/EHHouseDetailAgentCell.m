...
//    }
    ...
    if (regionsArray.count == 1) {
        ...
        label.frame = CGRectMake(self.mainRegion.frame.origin.x + 65,y, label.textWidth+10, 17);
    ...
    if (regionsArray.count == 2) {
        ...
        label0.frame = CGRectMake(self.mainRegion.frame.origin.x + 65,y, label0.textWidth+10, 17);
